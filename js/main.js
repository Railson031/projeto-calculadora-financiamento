...
let formulario = document.querySelector('#calculadora').addEventListener('submit', function (event) {
...
document.querySelector('#valorDeEntrada').addEventListener('keyup', function (event) {
  ...
  let valorDoBem = document.querySelector('#valorDeEntrada').value.trim();
  if (valorDoBem === '' || valorDeEntrada === '') {
    return
  }
